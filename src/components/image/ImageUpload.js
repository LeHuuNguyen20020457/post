...
const ImageUpload = (props) => {
    ...
    return (
        ...
        >
            <input type="file" name={name} className="hidden-input" onChange={onChange} {...rest} />
            {progress != 0 && !image && (
            ...
            {image && (
                <Fragment>
                    ...
                    <button
                        className="w-16 h-16 bg-white rounded-full flex items-center justify-center cursor-pointer absolute z-10 text-red-500 opacity-0 invisible trasition-all group-hover:opacity-100 group-hover:visible"
